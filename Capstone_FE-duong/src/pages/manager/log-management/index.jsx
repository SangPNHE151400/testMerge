...
const LogManagement = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 150,
      renderCell: (params) => {
        return <Box>{params.row?.checkin  === null || params.row?.checkout === null ? 0 : 1}</Box>
      }
    },
    {
      field: 'violate',
          ...
          <Box
            ...
            <Box
              ...
              <Button
                variant="contained"
                onClick={() =>
                  navigate(`/attendance-log-detail/${employee.accountId}/${params.row.date}/${params.row.changeLogId}`)
                }>
                View Log
              </Button>
            </Box>
