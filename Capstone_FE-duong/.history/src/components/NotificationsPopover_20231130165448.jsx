  ...
  useEffect(() => {
    if (arrivalNotification !== '') {
      setListNotifications({
        total: listNotifications.total + 1,
        notifications: [arrivalNotification, ...listNotifications.notifications]
      })
      toast.info(`You receive notification from ${arrivalNotification.senderName}`)
    }
  }, [arrivalNotification])
