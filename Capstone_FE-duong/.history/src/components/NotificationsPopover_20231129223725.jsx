...
const NotificationsPopover = () => {
  ...
  useEffect(() => {
    if (socket.current) {
      socket.current.on('msg-receive', (msg) => {
        setArrivalNotification({ notificationId: msg.notificationId, userId: msg.userId, readStatus: msg.readStatus, title: msg.title, uploadDate: msg.uploadDate, department: msg.department })
      })
    }
  }, [arrivalNotification])
  ...
  useEffect(() => {
    arrivalNotification && setListNotifications((pre) => [arrivalNotification, ...pre])
