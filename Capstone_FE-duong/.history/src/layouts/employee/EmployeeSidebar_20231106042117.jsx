  ...
  const [activeIndex, setActiveIndex] = useState(() => {
    const initialIndex =
      window.location.pathname === '/check-attendance'
        ...
        ? 2 :  window.location.pathname === '/notification-draft-emp'
        ? 3 : window.location.pathname === '/notification-receive-emp'
        ? 4 : window.location.pathname === '/notification-send-emp'
        ? 5 : window.location.pathname === '/notification-send-emp'
        ? 6 : window.location.pathname === '/notification-schedule-emp'
         0
    return initialIndex
  })
