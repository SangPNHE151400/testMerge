            ...
            : window.location.pathname === '/request-hr-list'
              ? 3 : window.location.pathname === '/book-room-hr'
                  ? 4 : window.location.pathname === '/notification-list-hr'
                    ? 5 : window.location.pathname === '/notification-draftlist'
                      ? 6 : window.location.pathname === '/notification-uploadsent'
                        ? 7 : window.location.pathname === '/notification-uploadreceive'
                            ? 8 : window.location.pathname === '/notification-schedulelist'
                              ? 10 : window.location.pathname === '/notification-department-hr' ? 9 :
    0
    return initialIndex
  })
