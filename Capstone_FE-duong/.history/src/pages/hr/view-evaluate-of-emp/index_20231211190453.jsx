  ...
  return (
    <>
      <Paper style={{ padding: '20px' }}>
        <Grid container spacing={6}>
          <Grid item xs={6}>
            ...
            <TextField
              ...
              value={`${evaluate.employeeUserName}`}
            />
          </Grid>
          <Grid item xs={6}>
        ...
        <Grid item xs={6} width="48%" mt={2}>
          ...
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DatePicker
              ...
              openTo="year"
              value={date}
              renderInput={(props) => <TextField sx={{ width: '100%' }} {...props} readOnly />}
            />
        ...
        <Typography fontSize='20px' mt={2} display='inline-block'>Note: </Typography>
            <span dangerouslySetInnerHTML={{ __html: evaluate?.note }} style={{display: 'inline-block', marginLeft: '5px'}}></span>
