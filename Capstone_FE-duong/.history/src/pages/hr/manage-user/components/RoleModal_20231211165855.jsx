...
const RoleModal = ({ open, handleClose, user, setAllUser }) => {
  ...
  console.log(allDepartment.filter((item) => {return item.departmentId === '2'}).departmentName);
        ...
        prevUser.map((userInfo) => {
          if (userInfo.accountId === user.accountId) {
            return {
              ...userInfo,
              roleName: role,
              departmentName: allDepartment.filter((item) => {return item.departmentId === department}),
              roomId: room
            }
          } else {
            return userInfo
