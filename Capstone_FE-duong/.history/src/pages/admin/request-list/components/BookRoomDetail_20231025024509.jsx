      ...
      <Box
        ...
        <Modal
            ...
            <Box sx={style} display='flex' flexDirection='column'>
              ...
              <textarea value={contentReason} onChange={(e) => setContentReason(e.target.value)} style={{width: '100%'}} rows={6}/>
              <Button onClick={handleRejectRequest} variant='contained' sx={{alignSelf: 'flex-end', mt: 2}}>Save</Button>
            </Box>
          </Modal>
      </Box>
    </Box>
