          ...
          <Table aria-label="collapsible table">
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{ width: '160px', fontWeight: 'bold', fontSize: '18px' }}>TicketID</TableCell>
                <TableCell style={{ width: '160px', fontWeight: 'bold', fontSize: '18px' }}>Topic</TableCell>
                <TableCell style={{ width: '200px', fontWeight: 'bold', fontSize: '18px' }}>Title</TableCell>
                <TableCell style={{ width: '150px', fontWeight: 'bold', fontSize: '18px' }}>Create Date</TableCell>
                <TableCell style={{ width: '150px' , fontWeight: 'bold', fontSize: '18px'}}>Update Date</TableCell>
                <TableCell style={{ width: '100px', fontWeight: 'bold', fontSize: '18px' }}>Status</TableCell>
                <TableCell style={{ width: '100px', fontWeight: 'bold', fontSize: '18px' }}>Action</TableCell>
              </TableRow>
            </TableHead>
           {isLoading ? ( 
