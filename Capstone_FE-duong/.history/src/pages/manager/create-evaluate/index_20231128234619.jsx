              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                  ...
                  <TableCell component="th" scope="row"></TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Total Attendance</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Morning Total</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Afternoon Total</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Late Checkin Total</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Early Checkout Total</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Permitted Leave</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Non Permitted Leave</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Violate Total</TableCell>
                    <TableCell sx={{fontSize: 17}} align="center">Paid Day</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  <TableRow
