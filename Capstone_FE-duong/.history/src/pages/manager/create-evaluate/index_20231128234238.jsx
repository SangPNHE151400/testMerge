        ...
        <Box>
            ...
            <form onSubmit={formik.handleSubmit}>
                <Box sx={{ padding: '20px' }}>
                            ...
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                ...
                                <TableRow
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">Morning Total</TableCell>
                                        <TableCell align="center">Afternoon Total</TableCell>
                                        <TableCell align="center">Late Checkin Total</TableCell>
                                        <TableCell align="center">Early Checkout Total</TableCell>
                                        <TableCell align="center">Permitted Leave</TableCell>
                                        <TableCell align="center">Non Permitted Leave</TableCell>
                                        <TableCell align="center">Violate Total</TableCell>
                    ...
                    {
                        show && selectedOption == "option1" && <Box mt={2}>
                            <EvaluateTable
                                rows={dailyLog}
                                columns={columnDaily}
                                isLoading={loading} />
                    ...
                    {
                        show && selectedOption == "option2" && <Box mt={2}>
                            <EvaluateTable
                                rows={overTimeData}
