              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                  ...
                  <TableCell component="th" scope="row"></TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Total Attendance</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Morning Total</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Afternoon Total</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Late Checkin Total</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Early Checkout Total</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Permitted Leave</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Non Permitted Leave</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Violate Total</TableCell>
                    <TableCell sx={{fontSize: 14}} align="center">Paid Day</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  <TableRow
