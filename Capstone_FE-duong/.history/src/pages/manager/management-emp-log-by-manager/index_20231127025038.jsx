        ...
        if (
          ...
          return (
            <>
              ...
              <Button variant="contained" style={{ backgroundColor: 'red', fontSize: '12px', marginLeft: '10px' }}>
                Re-Evaluate
              </Button>
            </>
          )
          ...
          return (
            <>
              ...
              <Button variant="contained" style={{ backgroundColor: 'gray', ...buttonStyle }} onClick={() => navigate(`/create-evaluate/${params.row.employeeId}/${format(month,'yyyy-MM-dd')}`)}>
                Evaluate
              </Button>
            </>
          )
