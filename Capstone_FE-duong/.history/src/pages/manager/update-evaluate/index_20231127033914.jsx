    ...
    <Box>
      ...
      <form onSubmit={formik.handleSubmit}>
        <Box sx={{ padding: '20px' }}>
          ...
          {
            userEvaluate?.acceptedHrId === null && (
                <Box mt={3}>
                    <Divider />
                    <Box display='flex' alignItems='center' gap='5px' mt={2} fontSize='20px'>Status: <Typography color='red' fontSize='16px'>Reject</Typography></Box>
                </Box>
            )
          }
