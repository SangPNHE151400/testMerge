...
export default function CheckAttendance() {
  function CustomToolbar() {
    ...
    const formattedDate = format(month, 'yyyy-MM-dd')
    console.log(formattedDate);
    // useEffect(() => {
    //   setIsLoading(true)
    //   const fetchAllUserAttendance = async () => {
    //     const response = await attendanceApi.getAttendanceUser(currentUser?.accountId, month)
  ...
  return <DataTableCheckAttendance rows={rows} columns={columns} CustomToolbar={CustomToolbar} />
}
