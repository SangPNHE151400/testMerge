...
const AttendanceRequestModal = ({ openAttendanceRequest, handleCloseAttendanceRequest }) => {
  ...
  const handleButtonClick = () => {
    // Do something before clearing or manipulate form values
    formik.setValues({title: '', content: ''}); // Clear form values
  };
  return (
    <Modal
        ...
        <Box p={3} pl={0}>
          <form onSubmit={formik.handleSubmit}>
            ...
            <Box pt={2} display="flex" alignItems="flex-end" justifyContent="space-between">
              ...
              <Button type="submit" variant="contained" nClick={handleButtonClick}>
                Save
              </Button>
            </Box>
          </form>
