    ...
    <>
      ...
      <Box
        ...
        <StripedDataGrid
          ...
          getRowClassName={(params) => (params.row.lateCheckin === true ? 'late-checkin-cell' : '') (params.row.dateDaily.startsWith('Sunday') || params.row.dateDaily.startsWith('Saturday') ? 'weekend-cell': '')}
          loading={isLoading}
          columns={columns}
          rows={rows}
