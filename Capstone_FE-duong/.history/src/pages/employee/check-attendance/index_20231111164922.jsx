...
export default function CheckAttendance() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 150,
      renderCell: () => (
        <Typography>{userAttendance.totalAttendanceUser.lateCheckinTotal}</Typography>
      )
    },
    {
      field: 'earlyCheckout',
      ...
      width: 150,
      renderCell: () => (
        <Typography>{userAttendance.totalAttendanceUser.earlyCheckoutTotal}</Typography>
      )
    },
    {
    ...
    },
    {
      ...
      valueGetter: ({ row, value }) => {
        if (row.id === 'TOTAL' && userAttendance && userAttendance.totalAttendanceUser) {
          return <Typography>{userAttendance.totalAttendanceUser.violateTotal}</Typography>
        }
        return value
      }
    },
