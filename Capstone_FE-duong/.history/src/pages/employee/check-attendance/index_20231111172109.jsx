...
export default function CheckAttendance() {
  ...
  const getCellClassName = ({ rows, field }) => {


    if (field === 'lateCheckin' && rows.lateCheckin) {
      return 'late-checkin-cell'
    }
    return ''
  }
  const columns = [
        ...
        return (
          <Box
            ...
            <Box
              ...
              {params.row.lateCheckin === true && <Button variant="contained">Late Request</Button>}
            </Box>
          </Box>
        )
      }
