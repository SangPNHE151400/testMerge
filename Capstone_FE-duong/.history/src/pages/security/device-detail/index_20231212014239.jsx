...
import { Autocomplete, Box, Button, Checkbox, Divider, MenuItem, Modal, Select, TextField, Typography,FormControl, InputLabel } from '@mui/material'
        ...
        <Box>
            ...
            <Box margin={3}>
                <Box display='flex' justifyContent='space-between'>
                    ...
                    {device?.rooms !== null && (
                        <Button onClick={handleOpenAddNew} variant='contained'>Add new</Button>
                    )}
                </Box>
                <Box marginTop='20px'>
