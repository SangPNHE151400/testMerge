...
import { Box, Button, MenuItem, Modal, Select, TextField, Typography, FormControl, InputLabel } from '@mui/material'
                ...
                return (
                    <Box
                        ...
                        <Box
                            ...
                            borderRadius="4px"
                            width="100%">
                            <Button onClick={() => handleOpenChangeUpdate(params.row)}><CreateIcon sx={{color: 'green'}} /></Button>
                            <Button onClick={() => handleOpenChangeStatus(params.row)}><ChangeCircleIcon /></Button>
                        </Box>
                    </Box>
                )
            }
