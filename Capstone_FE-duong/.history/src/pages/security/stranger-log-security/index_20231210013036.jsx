        ...
        <Box m={3}>
            ...
            <Select
              ...
              {listRooms.map((item, index) => (
                <MenuItem key={index} value={item.roomName}>
                  {item.roomName}
                </MenuItem>
              ))}
            </Select>
                    ...
                    >
                        {listDevice.map((item, index) => (
                            <MenuItem key={index} value={item?.deviceId}>{item?.deviceName}</MenuItem>
                        ))}
                    </Select>
                </>)}
                <Button variant="outlined" sx={{ width: '20%' }} onClick={(e) => handleSearch(e)} >Search</Button>
            </Box>
            <Box mt={3}>
                <DataTableStrangerLog
                    rows={listStranger}
                    columns={columns}
                />
            </Box>
