...
const TicketDetail = () => {
  ...
  return (
    <>
      ...
      <div
        ref={scrollbarsRef}
        style={{ overflow: 'auto', backgroundColor: '#333', maxHeight: '400px' }}>
        <StyledPaper>
          <Box display="flex" gap={1} alignItems="center">
            <Avatar src="/path/to/avatar.jpg" alt="Avatar" />
            <Box display='flex' flexDirection='column'>
            <Typography fontSize='14px' variant="body1" gutterBottom>
              Nguyen Thinh
            </Typography>
            <Typography fontSize='10px' variant="body1" gutterBottom>
              Admin
            </Typography>
            </Box>
          </Box>
