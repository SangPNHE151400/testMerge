        ...
        <>
            ...
            <Box display='flex'>
                <Box flex='5' display='flex'>
                    <Box flex='1' >
                        <Paper sx={{ margin: '20px 0px 0px 40px', p: '15px' }} >
                            <Typography fontWeight='700' fontSize='30px'>Information </Typography>
                        ...
                        <Paper sx={{ margin: '50px 0px 0px 40px', p: '15px'}}>
                            <Typography fontWeight='bold' fontSize='30px'>Control Log </Typography>
                    ...
                    <Box flex='1'>
                        <Box flex='1' marginRight='40px'>
                            <Paper sx={{ margin: '20px 0px 0px 40px', p: '15px' }}>
                                <Typography fontWeight='700' fontSize='30px'>Working Details </Typography>
                                <Box display='flex' marginTop='10px'>
                                    <Box flex='1' borderRight='1px solid #999'>
                            ...
                            <Paper sx={{ margin: '20px 0px 0px 40px', p: '15px' }}>
                                <Typography fontWeight='700' fontSize='30px'>Violate </Typography>
                                <Box display='flex' marginTop='10px'>
                                    <Box mr={2} pr={4} display='flex' flexDirection='column' gap='15px' borderRight='1px solid #999'>
