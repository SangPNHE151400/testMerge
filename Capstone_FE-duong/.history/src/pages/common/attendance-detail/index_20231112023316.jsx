            ...
            <Box flex="1" marginRight="40px">
              <Paper sx={{ margin: '20px 0px 0px 40px', p: '15px' }} elevation={4}>
                ...
                <Box display="flex" marginTop="10px">
                  ...
                  <Box flex="2" marginLeft="10px">
                    <Typography>{userAttendanceDetail?.dateDaily} </Typography>
                    <Typography>{userAttendanceDetail?.checkin} </Typography>
                    <Typography>{userAttendanceDetail?.checkout} </Typography>
                    <Typography>{userAttendanceDetail?.totalAttendance}</Typography>
                    <Typography>{userAttendanceDetail?.morningTotal}</Typography>
                    <Typography>{userAttendanceDetail?.afternoonTotal}</Typography>
                    <Typography>{userAttendanceDetail?.dateDaily}</Typography>
                    <Typography>{userAttendanceDetail?.permittedLeave}</Typography>
