              ...
              <Paper sx={{ margin: '40px 0px 0px 40px', p: '15px' }} elevation={4}>
                ...
                <Box display="flex" marginTop="10px">
                  ...
                  <Box display="flex" flexDirection="column" gap="15px">
                    <Checkbox sx={{ p: 0 }} checked={userAttendanceDetail?.lateCheckin} />
                    <Checkbox sx={{ p: 0 }} checked={userAttendanceDetail?.earlyCheckout} />
                    <Checkbox sx={{ p: 0 }} checked={userAttendanceDetail?.nonPermittedLeave} />
                  </Box>
                </Box>
              </Paper>
            </Box>
