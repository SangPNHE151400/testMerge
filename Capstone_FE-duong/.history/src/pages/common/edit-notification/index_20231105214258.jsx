...
const EditNotification = () => {
  ...
  console.log(formik.values.isAllDepartment, keepReceiver);
  return (
                ...
                <CardContent>
                  ...
                  <Box sx={{ mb: 1 }}>
                    <Grid item container spacing={3}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <FormControl>
                          <RadioGroup
                            ...
                            onChange={(e) => setKeepReceiver(e.target.value)} value={keepReceiver}>
                      ...
                      : formik.values.isAllDepartment === 'other' && keepReceiver === 'no'  && (
                        <>
                          <Grid item xs={6}>
