...
const EditNotification = () => {
  ...
  console.log(formatDate(notificationDetail?.uploadDate))
                  ...
                  <Box sx={{ mb: 1 }}>
                    <Grid item container spacing={3}>
                      ...
                      </Grid>
                      {
                        ...
                        <Grid item xs={12}>
                        <Typography display='flex' gap='10px' alignItems='center' mb={2} fontSize='20px'>Receiver: <Typography color='blue'>Send all staff</Typography></Typography>
