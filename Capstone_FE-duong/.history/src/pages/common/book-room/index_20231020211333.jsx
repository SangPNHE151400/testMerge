  ...
  const commitChanges = ({ added, changed, deleted }) => {
    setData((prevData) => {
      ...
      if (added) {
        ...
        const date = moment(added.startDate.toString());
        const time = date.format("HH:mm");
        console.log(time);
        // const dateStart = new Date(added.startDate.toString())
        ...
        // const dateEnd = new Date(added.endDate.toString())
        ...
        let data = {
          title: added.title,
          startDate: added.startDate.toString().split('T')[1].split(':')[0],
