  ...
  <AppointmentTooltip.Content {...restProps}>
    <Grid container alignItems="center">
      <Grid display='flex' gap='20px' mt='10px' ml='20px' item xs={10}>
        <RoomIcon sx={{color: '#999'}}/> <Typography>{receiveIdAndDepartment?.hrDepartmentResponse?.hrDepartmentName}</Typography>
      </Grid>
      <Grid display='flex' gap='20px' mt='10px' ml='20px' item xs={10}>
        <PersonIcon sx={{color: 'green'}} /> <Typography>sad</Typography>
      </Grid>
    </Grid>
