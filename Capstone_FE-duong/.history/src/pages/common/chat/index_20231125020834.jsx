...
const Chat = () => {
  ...
  console.log(messages)
  const senderIdToFind = 'a24f51de-45db-4eea-8aba-eefed8485ca4'
  const senderIndex = isActiveUser.user.indexOf(senderIdToFind)

  if (senderIndex !== -1) {
    console.log(isActiveUser.avatar[senderIndex])
  } else {
    console.log('SenderId not found in the user array.')
  }
  return (
    <Box height="100vh">
      <ChatTopbar />
                          ...
                          <>
                            <Box
                              ...
                              <Box mt="-14px">
                                <Avatar
                                  src={
                                    isActiveUser.avatar[isActiveUser.user.indexOf(item.senderId)]
                                  }
                                />
                              </Box>
                            </Box>
