...
const Chat = () => {
  ...
  return (
    <Box height="100vh">
      ...
      <Box display="flex" gap="20px" p={1.5} bgcolor="#f5f7f9" height="calc(100vh - 65px)">
        <Box
          ...
          <Box className="Chat-container">
            ...
            <Button onClick={handleOpen} variant='outlined' sx={{p: '0px 5px', fontSize: '15px', mr: '16px', textTransform: 'capitalize'}}>Create New Chat</Button>
            </Box>
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" textAlign='center' fontSize='18px'>
            Create New Chat
          </Typography>
