...
const Chat = () => {
  ...
  console.log(messages);
  console.log(isActiveUser.avatar[isActiveUser.user.indexOf('a24f51de-45db-4eea-8aba-eefed8485ca4')]);
  return (
    <Box height="100vh">
      <ChatTopbar />
                              ...
                              <div className="messageTop">
                                <div
                                  ...
                                  {item?.type === 'text' ? (
                                    ...
                                    item?.type === 'file' && (
                                      <div
                                        style={{ display: 'flex', gap: '5px', cursor: 'pointer', color: '#fff' }}>
                                        <TextSnippetIcon />
                      ...
                      {messages.map((item, index) =>
                        item?.myself === true ? (
                          ...
                          <Box display='flex' justifyContent='flex-end' alignItems='center' gap='5px'>
                            ...
                            <Box mt='-14px'><Avatar src={isActiveUser.avatar[isActiveUser.user.indexOf(item.senderId)]} /></Box>
                          </Box>
                          </>
                        ) : (
                          <>
                          <Box display='flex' alignItems='center' gap='5px'>
                          <Box mt='-14px'><Avatar /></Box>
                            <div
                              ref={scroll}
                              style={{ alignItems: 'flex-start' }}
                              className="message">
