      ...
      <Box display="flex" gap="20px" p={1.5} bgcolor="#f5f7f9" height="calc(100vh - 65px)">
        <Box
          ...
          <Box className="Chat-container">
            ...
            {allChatList
              .filter((user) =>
                user.chatName.includes(debouncedSearch)
              ).map((item) => (
              <>
                        ...
                        item?.myself === true ? (
                          ...
                          <>
                            <Box display="flex" alignItems="center" gap="5px">
                              <Box mt="-14px">
                              <Tooltip title={userAvatar[userAvatar.findIndex((avatar) => avatar.userId === item.senderId)].username}>
                                <Avatar
                                  src={
                                    userAvatar[userAvatar.findIndex((avatar) => avatar.userId === item.senderId)].image
                                  }
                                />
                              </Tooltip>
                              </Box>
