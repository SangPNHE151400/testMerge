...
import { top100Films } from './components/top100Film'
    ...
    <Box height="100vh">
                  ...
                  {item?.accountId !== currentUserId ? (
                    <div
                      ...
                      <Stack p={1} display="flex" direction="row" spacing={1} mb={1}>
                        {item?.image !== 'unknown' ? (
                          <Avatar src={`${item?.imgUrl}`} sx={{ width: '50px', height: '50px' }} />
                        ) : (
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          {option === 'group' ? (
            <>
              <TextField sx={{ mt: 2, mb: 3 }} fullWidth label="Chat Name" name="chatName" onChange={(e) => setChatName(e.target.value)}/>
              <Autocomplete
                multiple
                id="tags-outlined"
                options={allUser}
                ...
                onChange={(event, newValue) => setSelectedUser(newValue.map(user => user.accountId))}
           ...
           <TextField sx={{ mt: 2, mb: 3 }} fullWidth label="Message" name="message" onChange={(e) => setChatNameMessage(e.target.value)}/>
