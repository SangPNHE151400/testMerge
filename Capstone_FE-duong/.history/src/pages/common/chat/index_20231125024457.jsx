...
const Chat = () => {
  ...
  console.log(userAvatar.filter((item) => item.userId === currentUserId)[0].image)
  return (
    <Box height="100vh">
      <ChatTopbar />
                          ...
                          <>
                            <Box
                              ...
                              <Box mt="-14px">
                                <Avatar
                                  src={
                                    userAvatar && userAvatar.filter((item) => item.userId === currentUserId)[0]
                                      .image
                                  }
                                />
                              </Box>
                          ...
                          <>
                            <Box display="flex" alignItems="center" gap="5px">
                              <Box mt="-14px">
                                <Avatar
                                  src={
                                    userAvatar && userAvatar.filter((avatar) => avatar.userId === item.senderId)[0]
                                      .image
                                  }
                                />
                              </Box>
