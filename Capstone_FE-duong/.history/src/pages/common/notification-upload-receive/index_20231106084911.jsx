    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          ...
          >
            <div>
              <Button variant='contained' onClick={() => handleDetailClick(params.row)}>Detail</Button>
              {
                params.row.readStatus === false ? <Button variant='contained' onClick={() => handelChangeStatus(params.row)}>Mark as read</Button> : <Button variant='contained' onClick={() => handelChangeStatus(params.row)}>Mark as unread</Button>
              }
            </div>
          </Box>
        );
