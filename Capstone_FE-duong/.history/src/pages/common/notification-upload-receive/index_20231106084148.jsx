...
const NotificationUploadReceive = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      filterable: false,
      renderCell: (params) => {
        const currentRow = params.row; // Store the current row in a local variable
    
        const handleDetailClick = () => {
          navigate(`/notification-detail/${currentRow.notificationId}/${currentRow.creatorId}`);
        }
    
        const handleStatusChangeClick = () => {
          handelChangeStatus(currentRow);
        }
